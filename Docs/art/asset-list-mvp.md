...
- `SPR_UI_RaceHud_PauseButton` — только если пауза подтверждена как часть MVP;
- `SPR_UI_Countdown_03`;
- `SPR_UI_Countdown_02`;
- `SPR_UI_Countdown_01`;
- `SPR_UI_Countdown_Go`.

### 5.4. Result и leaderboard
#### Обязательно
...
### 6.2. Подготовка под palette swap
...
### Этап 3. Меню и поддерживающий UI
Далее необходимо сделать:
- menu buttons;
- map card;
- bike card;
- leaderboard panel;
- settings / daily reward иконки.
